...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="./PRETRAIN_MODEL/RegLLM/RNA", help="Output directory")
    parser.add_argument("--fasta_file", type=str, default="data/ensembl_id80_rep_seq.fasta", help="Path to FASTA file")
    parser.add_argument("--load_checkpoint", action='store_true', help="load from checkpoint")
    parser.add_argument("--checkpoint_path", type=str, default="/g/data/ws52/kd1348/RegLLM_Pretrain/PRETRAIN_MODEL/NucEL/", help="Input dataset")
